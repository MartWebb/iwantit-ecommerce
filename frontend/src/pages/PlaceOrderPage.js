...
function PlaceOrderPage({ history }) {
    ...
    // If payment not chosen redirect to payment page
    ...
    cart.shippingPrice = cart.itemsPrice > 50 ? toFloatingNumber(0) : toFloatingNumber(15);
    cart.taxPrice = toFloatingNumber(0.13 * cart.itemsPrice);
